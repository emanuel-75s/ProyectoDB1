 ...
 */
package example.proyectodb.dao.VistaMySQLDAO;
 ...
 * @author emanu
 */
public class VistaMySQLDAO implements IVistaDAO {
    ...
    public double obtenerTotalVentasHoy() {
        double total = 0.0;
        String sql = "SELECT COALESCE(SUM(precio_total), 0) AS total FROM vista_ventas_hoy";
